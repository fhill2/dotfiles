  ...
  sections = {
    ...
    lualine_c = {
      ...
      },
      {
        ...
        icon = '',
        --color = {fg = colors.red },
        color = function(section) return { fg = lualine_lsp_enabled and colors.base0B or colors.base08, gui = 'italic,bold' } end,
      },
      {
        get_ts,
        icon = '',
        color = function(section) return { fg = ts_enabled() and colors.base0B or colors.base08, gui = 'italic,bold' } end,
      },
      {
        pyright_venv,
        icon = '',
