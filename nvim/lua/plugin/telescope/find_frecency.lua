  ...
  function get_entry_maker(opts)
    ...
    local make_display = function(entry)
      ...
      if opts.dirs_only or entry.is_dir then
        ...
        icon, icon_highlight = devicons.get_icon(entry.value, string.match(entry.value, "%a+$"), { default = true })
        if icon == "" then
    ...
    return function(fp)
      ...
      if opts.dirs_and_files then entry.is_dir = stat.type == "directory" end
